...
function update_object(obj, form_el) {
    flatten.set_values(obj, get_element_names(form_el).map(function (k) {
...
/** Shorthand for ``formson.update_form(form_el, {})``. */
function form_to_object(form_el) {
    var obj = {};

    update_object(obj, form_el);
    return obj;
}
